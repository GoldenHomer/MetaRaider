window.onload = function() {
	...
	// this eventListener is when user adds XML file to file input
	input.addEventListener('change', function(e){
		...
		function appendToFrontEnd(xml) {
			...
			var checkForFormat = /dcterms/gm; // check if XML file selected is Dublin Core Terms format
			
			var termMatches = xml.responseText.match(termNames);
			var fieldMatches = xml.responseText.match(fieldValues);
			var formatMatch = xml.responseText.match(checkForFormat);
